...
const foodArr = [
    {
        ...
        popularity: 10,
        rating: 8,
        tags: ["Classic", "America's Favorite"]
    },
    {
        name: "Supreme",
        price: 15.00,
        catergory: "Hand Tossed",
        popularity: 7,
        rating: 7,
        tags: ["Flavorful", "My Favorite"]
    },
    {
        name: "Hawaiian",
        price: 12.00,
...
const filteredFood = foodArr.filter((element) => {
    if(element.tags.includes("Classic")) {
        return element;
    }
});
